...
with st.container():
    ...
    with col1:
        ...
        param_p = st.number_input('Insert the value of hyperparameter p', min_value=0, max_value=10, value=0)
    ...
    with col2:
        ...
        param_q = st.number_input('Insert the value of hyperparameter q', min_value=0, max_value=10, value=0)
